...
INSERT INTO components (Category_Code, Component_Code, Name, Comment, procurement_flag, common_parts_flag) VALUES
('ELEVATOR', 'ELE-001', '电梯主机', '电梯核心动力设备', false, false),
('DOOR', 'DOOR-001', '电梯门机', '电梯门开关控制设备', false, true),
('CABIN', 'CABIN-001', '电梯轿厢', '电梯载客厢体', false, false),
('RAIL', 'RAIL-001', '电梯导轨', '电梯运行轨道', true, true),
('CABLE', 'CABLE-001', '电梯电缆', '电梯电力传输线缆', true, true);
